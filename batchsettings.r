...
rawFHPaths =c("./rawFH/rawFH_FIRE_HISTORY_LF_DISTRICT_1755.gpkg")#FIRE_HISTORY20210310_DemoAdHocPolygon.gpkg") 
...
yearsForRasters = c(2020) # vector of SEASONS within limit of , or NULL for all years

...
source("tempsettings.r")

print("line before R script runs")
...
knitr::kable(
  SppT,booktabs=TRUE,caption = paste0('Table 2: List of the ', lSppt, ' species considered within the area of interest.'),longtable = TRUE)
```
